"""This module is responsible for instantiation of the database client """
...
class DatabaseInstance:
    """
    This Class creates the skeletal structure required for instantiation of the database client.
    
    Key Methods:
    1. initialize_session(self)
